# -*- coding: utf-8 -*-
# Generated by Django 1.11.29 on 2022-11-15 09:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('editor_parameters', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jcom_profile.EditorAssignmentParameters')),
